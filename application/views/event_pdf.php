...
<body onload="window.print()" class="print-area">
    <div class="team-member-card">
        <img src="<?= base_url("uploads/user_profile/$timeline_owner[user_image]") ?>" alt="Profile Picture">
        <div class="team-member-info">
            <h6><?= $timeline_owner['name'] ?></h6>
            <div><strong>Email:</strong> <?= $timeline_owner['email'] ?> </div>
            <div><strong>Phone:</strong> <?= $timeline_owner['phone'] ?> </div>
        </div>
    </div>
    <?php
        $dragButtonMap = [
        ...
        <?php if (!empty($event)): ?>
            <div class="" style="margin-bottom: 0.3cm;">
                <div class="d-flex align-items-center">
                    ...
                    <span class="text-white py-1 px-2 rounded" style="margin-left: 1cm; background-color: rgb(13, 110, 253);">
                    <?php
                        $timeline_type_map = [
                            '0' => 'Task',
                            '1' => 'Milestone',
                    ...
                    <?php switch ($item['content_type']):
                        ...
                        <?php case 'user': ?>
                            ...
                            <div class="my_timeline py-4">
                                ...
                                <div class="timeline-users-wrapper w-100 h-100">
                            ...
                            <?php case 'country' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars(getCountryName($item['country_code'])) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'probability' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars(getCountryName($item['probability'])) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'religion' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars(getCountryName($item['religion'])) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'emotion' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars(getCountryName($item['emotion'])) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'level' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars(getCountryName($item['level'])) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'currency' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars(getCountryName($item['currency'])) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'travel' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars($item['travel']) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'age' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars($item['age']) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'body_part' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars($item['body_part']) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'ethnicity' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars($item['ethnicity']) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
                            ...
                            <?php case 'character' :?>
                                <div class="timeline-output country-output">
                                    <span><?= htmlspecialchars($item['character']) ?></span>
                                    <span class="edit-item">
                                        <i class="bi bi-pencil" title="Edit"></i>
                                    </span>
                                    <span class="delete-item">
