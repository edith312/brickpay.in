            ...
            <div id="calendarWrapper">
                ...
                <div id="calendarFilters" style="margin-bottom: 15px; text-align: right;">
                    <button class="btn-filter">
                        <a class="me-auto text-light" href="<?= base_url('admin/data-feeding-panel') ?>" >Data Feeding Panel</a>
                    </button>
...
<script>
    ...
    $(document).on('click', '.event-item', function (e) {
        ...
        window.location.href = `<?=base_url('admin/data-feeding-panel')?>?id=${timelineId}`
    })
</script>
<!-- Shiv Web Developer -->