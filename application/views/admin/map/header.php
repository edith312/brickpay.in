...
$menu = [
    ...
    // ],
    "2.Degrees" => [
        "2.1 Bachelors" => "admin/degree/bachelors",
        "2.2 Masters" => "admin/degree/masters",
        "2.3 PHD" => "admin/degree/phd",
        "2.4 Professional / Diploma / Certificate" => "admin/degree/professional"
    ],
    "3.Industries" => [
        "Science" => [
        ...
        "3.1 Department" => "admin/industries/department",
    ],
    "4.Market Research" => [
        "Market Research" => "admin/market-research"
    ...
    "9.Reverse The Process" => "admin/reverse-process",
];
