    ...
    <div class="row align-items-start">
        <div class="col-md-3">
            ...
            <div id="sidebar">
                ...
                <input type="datetime-local" name="artificialdate" id="datetime-local" class="form-control mt-3"
                    placeholder="Date & Time" style="width:280px;" />
            </div>
        ...
        <div class="col-md-9">
            ...
            <div id="calendarWrapper">
                ...
                <div id="calendarFilters" style="margin-bottom: 15px; text-align: right;">
                    <button class="btn-filter me-auto" id="openModelforDataFeeding">Data Feeding Panel</button>
...
<div id="dayModal" class="modal">
    <div class="modal-content">
        ...
        <div class="d-flex">
            <div class="input-box">
                <label> Opening </label>
                <input type="time" id="openingTime" id="openingTime" class="time-input">
            </div>
            <p class="mt-1 mx-3"> -- </p>
            <div class="input-box">
                <input type="time" id="closingTime" id="closingTime" class="time-input">
                <label> Closing</label>
            </div>
            <div class="mx-2">
                <button class="btn btn-secondary btn-sm" id="openModelforTimeStamp">Add </button>
            </div>
        </div>
        <hr>
...
<div id="dataFeedingModal" class="modal calendar-modal" data-schedule="fixed">
    <div class="modal-content">
        ...
        <h2>Select Time</h2>
        <input type="date" name="artificialdate" id="modalDateName" class="form-control mt-3" placeholder="Date &amp; Time" style="width:280px;">
        <div class="d-flex gap-2 mt-3">
            <div class="input-box">
                <label> Opening </label>
                <input type="time" id="showOpening" class="time-input form-control" value="00:00" autocomplete="off">
            </div>
            <div class="input-box">
                <label> Closing</label>
                <input type="time" id="showClosing" class="time-input form-control" value="00:00" autocomplete="off">
            </div>
        </div>
        <div class="bodycontentforModel">
            <div class="actionareaViewCase">
                ...
                <div class="d-flex mt-2">
                    ...
                    <div class="mx-2">
                        <button class="btn btn-sm tab-btn draggable-btn text-white" style="background-color: #04d6e5ff !important;" id="refreshTab"
                            data-url="<?= base_url('Calendar/getOtherLinksdata') ?>"
                            data-type="other"
                            data-target="#textDataContainer8"
                            data-box="#box_pressRelease"
                            draggable="true"
        ...
        const mainCalendar = new FullCalendar.Calendar(calendarEl, {
            ...
            dayCellDidMount: function (info) {
                ...
                info.el.addEventListener("click", function () {
                    ...
                    $.ajax({
                        url: "<?= base_url("Calendar/getCalendarDataNew") ?>",
                        type: "POST",
                        dataType: "json",
                        data: {
                        dateStr
                        ...
                        success: function (res) {
                            ...
                            $("#timeListAM li, #timeListPM li").each(function () {
                                ...
                                res.events.forEach(item => {
                                    ...
                                    const startMin = toMinutes(item.openingtime);
                                    const endMin = toMinutes(item.closingtime);
                                    ...
                                    const colIndex = getStableColumnIndex(item.data.id, startMin, endMin, columns, eventColumnMap);

                                    if (colIndex === null) {
                                        console.warn('Timeline full, skipping event:', item.data.id);
                                        return;
                                    }
...
<script>
    ...
    $(document).ready(function () {
        ...
        function getFinalDateTime(modal) {
            ...
            const dateText = $(modal).find('#modalDateName').val().trim();
        ...
        $(document).on('click', '.save-btn', function (e) {
            ...
            if (scheduleType === 0) {
                ...
                formData.append("openingTime", $modal.find("#showOpening").val());
                formData.append("closingTime", $modal.find("#showClosing").val());
