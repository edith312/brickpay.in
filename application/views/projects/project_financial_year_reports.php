        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <table class="custom-table text-center">
                    ...
                    <tbody>
                            <?php foreach($getProject['financial_years'] as $key => $financial_year): ?>
                            <?php
                                ...
                                <form action="<?= base_url('home/save_project_financial_report') ?>" 
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center gap-2">
                                            <label for="financial_report_file_<?= $getProject['id'].'_'.$financial_year ?>" 
                                                class="btn"
                                            ...
                                            <input type="file"
                                                id="financial_report_file_<?= $getProject['id'].'_'.$financial_year ?>"
