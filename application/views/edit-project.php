        ...
        <div class="container w-100 pt-24 shadow-lg bg-white p-4" style="border-radius: 12px;">
            ...
            <div class="row">
                <div class="mb-3 col-md-4 col-12">
                    <input type="hidden" name="project_status" value="<?= $getProject['project_status']; ?>">

                    <label for="project_name" class="form-label">Project Name</label>
                    <input class="form-control" type="text" name="project_name" id="project_name" value="<?= $getProject['project_name']; ?>" required>
                ...
                <div class="mb-3 col-md-4 col-12 mt-md-4">
                    ...
                    <div class="input-group position-relative">
                        ...
                        <input class="form-control" type="text" id="searchInput" placeholder="Search companies..." value="<?= $getCompanyDetails['company_name']; ?> (CIN: <?= $getCompanyDetails['ciin_number'] ?>)">
                        <input type="hidden" id="selectedCompanyId" name="selected_company_id" value="<?= $getProject['company_id']; ?>">
                ...
                <div class="row">
                    <div class="mb-3 col-md-4 col-12">
                        ...
                        <input class="form-control" type="text" name="project_leader" id="project_leader" value="<?= $getProject['project_leader']; ?>" required>
                    ...
                    <div class="mb-3 col-md-3 col-12">
                        ...
                        <div class="input-range-wrapper">
                            <input class="form-control" type="number" name="layer_range_from" maxlength="5" oninput="limitLength(this, 3)" required value="<?= $getProject['layer_range_from'] ?>">
                            <span class="range-separator">-</span>
                            <input class="form-control" type="number" name="layer_range_to" maxlength="5" oninput="limitLength(this, 3)" required value="<?= $getProject['layer_range_to'] ?>">
                        </div>
                    ...
                    <div class="mb-3 col-md-3 col-12">
                        ...
                        <div class="input-range-wrapper">
                            <input class="form-control" type="number" name="team_range_from" maxlength="5" oninput="limitLength(this, 3)" required value="<?= $getProject['team_range_from']; ?>">
                            <span class="range-separator">-</span>
                            <input class="form-control" type="number" name="team_range_to" maxlength="5" oninput="limitLength(this, 3)" required value="<?= $getProject['team_range_to']; ?>">
                        </div>
                ...
                <div class="row g-0">
                    <div class="mb-3 col-md-3 col-12">
                        ...
                        <input class="form-control" type="number" name="project_valuation" id="project_valuation" value="<?= $getProject['project_valuation']; ?>" required>
                        <?= form_error('project_valuation', '<div class="text-danger">', '</div>'); ?>
                    </div>

                    <div class="mb-3 col-md-3 col-12">
                        <label for="issued_shares" class="form-label">Issued Shares</label>
                        <input class="form-control" type="number" name="issued_shares" id="issued_shares" value="<?= $getProject['issued_shares']; ?>" required>
                        <?= form_error('issued_shares', '<div class="text-danger">', '</div>'); ?>
                    </div>

                    <div class="mb-3 col-md-3 col-12">
                        <label for="face_value" class="form-label">Face Value</label>
                        <input class="form-control" type="number" name="face_value" id="face_value" value="<?= $getProject['face_value']; ?>" required>
                        <?= form_error('face_value', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="mb-3 col-md-3 col-12">
                        <label for="face_value" class="form-label">Current Price</label>
                        <input class="form-control" type="number" name="current_price" id="current_price" value="<?= $getProject['current_price']; ?>" required>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6 col-6">
                        <label class="col-form-label text-end d-flex justify-content-between align-items-center">
                            <span>Project Document/Policies</span>
                        ...
                        <?php if (!empty($getProject['project_document'])): ?>
                            <div class="mt-2">
                                <a href="<?= base_url('uploads/project_docs/' . $getProject['project_document']); ?>" target="_blank" class="text-primary">
                    ...
                    <div class="mb-3 col-md-6 col-6">
                        ...
                        <?php if (!empty($getProject['project_pitch'])): ?>
                            <div class="mt-2">
                                <a href="<?= base_url('uploads/project_docs/' . $getProject['project_pitch']); ?>" target="_blank" class="text-primary">
                ...
                <!-- TAM, SAM, SOM -->
                <div class="d-flex">
                    <div class="mb-3 px-2 col-md-4">
                        <label>TAM(Total Available Market) </label>
                        <input class="form-control" type="number" name="tam" value="<?= $getProject['tam']; ?>" required>
                        <?= form_error('tam', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="mb-3 px-2 col-md-4">
                        <label>SAM (Serviceable Available Market)</label>
                        <input class="form-control" type="number" name="sam" value="<?= $getProject['sam']; ?>" required>
                        <?= form_error('sam', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="mb-3 px-2 col-md-4">
                        <label>SOM (Serviceable Obtainable Market)</label>
                        <input class="form-control" type="number" name="som" value="<?= $getProject['som']; ?>" required>
                ...
                <div class="mb-3 w-100">
                    ...
                    <textarea class="form-control" name="project_overview" rows="4" id="project_overview" placeholder="Write your elevator pitch here..." required><?= $getProject['project_overview']; ?></textarea>
                ...
                <div class="row">
                    <div class="mb-3 col-md-6 col-12">
                        ...
                        <textarea class="form-control" name="mission" rows="3" placeholder="Write your Mission..." required><?= $getProject['mission']; ?></textarea>
                        <?= form_error('mission', '<div class="text-danger">', '</div>'); ?>
                    </div>

                    <div class="mb-3 col-md-6 col-12">
                        <label>Vision (Max 100 Words)</label>
                        <textarea class="form-control" name="vision" rows="3" placeholder="Write your Vision..." required><?= $getProject['vision']; ?></textarea>
