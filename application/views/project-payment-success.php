...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full text-center">
        ...
        <p class="text-lg text-gray-700 mb-2">Dear <span id="userName" class="font-semibold"><?= $user['project_name'] ?></span>,</p>
        <p class="text-gray-600 mb-4">We have successfully received your payment.</p>

        <div class="border-t border-b py-4 mb-6">
            <p class="text-gray-700"><span class="font-semibold">Payment Amount:</span> ₹<span id="paymentAmount">51.00</span></p>
