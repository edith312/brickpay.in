    ...
    <div class="card border-0">
        ...
        <form method="POST" action="" class="p-3">
            <div class="row justify-content-center">
                <div class="d-flex gap-0 p-md-2 p-0 mb-md-1 mb-3">
                ...
                <div class="d-flex flex-column flex-md-row gap-3 mb-3 mt-3 w-100 p-md-1 p-0">
                    <div class="form-group d-flex align-items-center w-100">
                        ...
                        <?= form_error('pan_number', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center w-100">
                        ...
                        <?= form_error('tan_number', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center w-100">
                        ...
                        <?= form_error('gst_number', '<div class="text-danger">', '</div>'); ?>
                    </div>
                </div>
                ...
                <div class="table-responsive-wrapper">
                    <table id="directorTable" style="width: 100%; border-collapse: collapse; text-align: center;" class=" dotted-bottom">
                        ...
                        <tbody>
                            <?php
                            if (!empty($getDirectors)):
                                $directorCount = 1;
                                foreach ($getDirectors as $director):
                            ?>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 10px;"><strong><?= $directorCount++ ?>.</strong></td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Enter Director Name" name="director_name[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $director['director_name'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Enter DIN Number" name="director_din_number[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $director['director_din_number'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Enter Mobile Number" name="director_mobile_number[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $director['director_mobile_number'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Enter Email" name="director_email[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $director['director_email'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Enter Permanent Address" name="director_address[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $director['director_address'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px; text-align: center;">
                                            <button class="removeRowBtn" style="display: flex; align-items: center; justify-content: center; padding: 6px 10px; border: 1px solid crimson; background-color:rgb(255, 230, 230); color:crimson; border-radius: 4px; cursor: pointer;" type="button">
                ...
                <div class="table-responsive-wrapper">
                    <table id="accountTable" style="width: 100%; border-collapse: collapse; text-align: center;" class="mb-3 dotted-bottom">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 10px;"><strong><?= $bankCount++ ?>.</strong></td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Account Holder" name="account_holder_name[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $banks['account_holder_name'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Account Number" name="account_number[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $banks['account_number'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="Bank Name" name="bank_name[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $banks['bank_name'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px;">
                                            <input type="text" class="fs-13" placeholder="IFSC Code" name="ifsc_code[]" style="width: 100%; padding: 5px; border: 1px solid #888; outline: none; text-align: center; border-radius: 4px;" value="<?= $banks['ifsc_code'] ?>" />
                                        </td>
                                        <td style="border: 1px solid #ccc; padding: 10px; text-align: center;">
                                            <button class="removeBankRowBtn" style="display: flex; align-items: center; justify-content: center; padding: 6px 10px; border: 1px solid crimson; background-color:rgb(255, 230, 230); color:crimson; border-radius: 4px; cursor: pointer;" type="button">
                                                <i class="fa fa-times" style="font-size: 16px;"></i>
                                            </button>
                                        </td>
                                    </tr>
                ...
                <div class="d-flex justify-content-between flex-wrap gap-3 mt-3">
                    <div class="d-flex gap-3 flex-wrap align-items-center">
                        <div class="d-flex gap-0 align-items-center">
                            ...
                            <div class="border rounded px-3 py-2 bg-white shadow-sm text-center" style="min-width: 200px;">
                                <input type="text" name="employercount" value="<?= set_value('employercount', $getProfile['employercount'] ?? ''); ?>" class="form-control text-center border-0 bg-transparent fw-bold p-0" />
                            </div>
                        ...
                        <div class="d-flex gap-0 align-items-center">
                            <button type="button" class="btn btn-info shadow-sm create-company-profile" style="color: #fff;">
                                Current Employer Count
                            </button>
                            <div class="border rounded px-3 py-2 bg-white shadow-sm text-center" style="min-width: 200px;">
                                <input type="text" name="currentemployercount" value="<?= set_value('currentemployercount', $getProfile['currentemployercount'] ?? ''); ?>" class="form-control text-center border-0 bg-transparent fw-bold p-0" />
                            </div>
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        ...
                        <button type="button" class="btn btn-warning shadow-sm text-dark create-company-profile">
                    ...
                    <div class="d-flex gap-3 flex-wrap align-items-center">
                        <div class="d-flex gap-0 align-items-center">
                            ...
                            <div class="border rounded px-3 py-2 bg-white shadow-sm text-center" style="min-width: 200px;">
                                <input type="text" name="lifetimerevenue" value="<?= set_value('lifetimerevenue', $getProfile['lifetimerevenue'] ?? ''); ?>" class="form-control text-center border-0 bg-transparent fw-bold p-0" />
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-0 align-items-center">
                            <button type="button" class="btn btn-secondary shadow-sm create-company-profile"
                                style="background-color: #0dcaf0; color: #fff;">
                                Current Revenue generated at <br> the time of account creation
                            </button>
                            <div class="border rounded px-3 py-2 bg-white shadow-sm text-center" style="min-width: 200px;">
                                <input type="text" name="currentlifetimerevenue" value="<?= set_value('currentlifetimerevenue', $getProfile['currentlifetimerevenue'] ?? ''); ?>" class="form-control text-center border-0 bg-transparent fw-bold p-0" />
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        directorTable.addEventListener('click', (event) => {
            if (event.target.closest('.removeRowBtn')) {
                const row = event.target.closest('tr');
                row.remove();
                updateRowNumbers(directorTable);
            }
        });
        accountTable.addEventListener('click', (event) => {
            if (event.target.closest('.removeBankRowBtn')) {
                const row = event.target.closest('tr');
                row.remove();
                updateRowNumbers(accountTable);
            }
        });
